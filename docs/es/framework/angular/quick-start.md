...
translation-updated-at: '2025-05-02T04:23:46.538Z'
title: Inicio rápido
id: quick-start
---
# Inicio Rápido

Ejemplo básico de una aplicación Angular para comenzar con TanStack angular-store.
...
<p>
  Presiona uno de los botones para agregar un contador de cuántos de tus amigos prefieren
  gatos o perros
</p>
...
// ¡Puedes instanciar el store fuera de los componentes de Angular también!
...
@Component({
    ...
    template: `
        <!-- Esto solo se volverá a renderizar cuando animal cambie. Si una propiedad no relacionada del store cambia, no se volverá a renderizar -->
